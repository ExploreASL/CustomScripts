...
cd $xASLdir;
screen -dmSL $screenNameFinalize nice -n 10 $MatlabPath -nodesktop -nosplash -r "cd('$xASLdir');ExploreASL('$DatasetRoot', 0, [1 0 0], false, 1, 1);system('screen -SX $screenNameFinalize kill');" &
