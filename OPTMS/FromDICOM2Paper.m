...
% Make sure that all folders and subfolders are converted
...
% Then run:
/ExploreASL_Import(ExploreASL_ImportConfig('c:\BackupWork\AS:\QSMSC\' % in this example. Important to provide the full path, and last folder/layer is the study ID
...
xASL_io_SplitASL_M0('C:\BackupWork\ASL\QSMSC\analysis\Sub-001\ASL_1\ASL4D.nii',[1 2]) % meaning that the first 2 volumes are M0 (this will always be the case, unless Philips changes this in a future update...)
% move the DataPar.m file into the analysis folder (this will be the
% analysis root folder) see in /CustomScripts/OPTMS/DataPar.m for a copy
ExploreASL_Master('C:\BackupWork\ASL\QSMSC\analysis\DataPar.m');
