...
Odir = '/home/bestevespadrela/lood_storage/divi/Projects/ExploreASL/DDI/ASL_dicoms';
Ddir = '/home/bestevespadrela/lood_storage/divi/Projects/ExploreASL/DDI/sourcedata';
...
for iT=1:length(Slist1) % There are more T1 files than ASL files, so Slist1 gives us the ASL files
    ...
    scannerlist{iT,3} = [txt.Manufacturer '_' txt.ModelName '_' strrep(txt.SoftwareVersion,'/','\')];
    ...
    if ~isempty(strcmp(SessionNameT,Sessions))
        ...
        xASL_Copy(T1txtList{iT},T1DestDir,true); % Copies T1.txt also
    end
end
...
root = '/home/bestevespadrela/lood_storage/divi/Projects/ExploreASL/DDI';
