...
for iV=1:4
    IM_name{1}{iV}     = fullfile( ROOT{iV}, 'dartel', ['rT1_'   Subject{iV} '.nii']); % T1
    IM_name{2}{iV}     = fullfile( ROOT{iV}, 'dartel', ['rc1T1_' Subject{iV} '.nii']); % pGM
    IM_name{3}{iV}     = fullfile( ROOT{iV}, 'dartel', ['PWI_' Subject{iV} '_ASL_1.nii']); % PWI
...
figure(1);imshow([singlesequencesort(view_IM{1},4);singlesequencesort(view_IM{2},4);singlesequencesort(view_IM{3},4);singlesequencesort(view_IM{4},4)],[0 100])
