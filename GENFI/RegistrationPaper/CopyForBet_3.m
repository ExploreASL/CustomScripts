...
%     iCopy       = fullfile( IDIR, FList{iF}, 'c1T1.nii');
%     oCopy       = fullfile( ODIR, ['GE_' FList{iF} '_pGM.nii']);    
%     xASL_Copy( iCopy, oCopy);    
%     iCopy       = fullfile( IDIR, FList{iF}, 'T1.nii');
%     oCopy       = fullfile( ODIR, ['GE_' FList{iF} '_T1.nii']);    
%     xASL_Copy( iCopy, oCopy);        
end
%%
...
for iF=1:12
    ...
    xASL_Copy( iCopy, oCopy);
%     iCopy       = fullfile( IDIR, FList{iF}, 'c1T1.nii');
%     oCopy       = fullfile( ODIR, ['SI_' FList{iF} '_pGM.nii']);    
%     xASL_Copy( iCopy, oCopy);        
%     iCopy       = fullfile( IDIR, FList{iF}, 'T1.nii');
%     oCopy       = fullfile( ODIR, ['SI_' FList{iF} '_T1.nii']);    
%     xASL_Copy( iCopy, oCopy);            
end
%%
...
for iF=1:12
    ...
    xASL_Copy( iCopy, oCopy);
%     iCopy       = fullfile( IDIR, FList{iF}, 'c1T1.nii');
%     oCopy       = fullfile( ODIR, ['PHBsup_' FList{iF} '_pGM.nii']);    
%     xASL_Copy( iCopy, oCopy);        
%     iCopy       = fullfile( IDIR, FList{iF}, 'T1.nii');
%     oCopy       = fullfile( ODIR, ['PHBsup_' FList{iF} '_T1.nii']);    
%     xASL_Copy( iCopy, oCopy);            
end
%%
...
for iF=1:12
    ...
    xASL_Copy( iCopy, oCopy);
%     iCopy       = fullfile( IDIR, FList{iF}, 'c1T1.nii');
%     oCopy       = fullfile( ODIR, ['PHnonBsup_' FList{iF} '_pGM.nii']);    
%     xASL_Copy( iCopy, oCopy);        
%     iCopy       = fullfile( IDIR, FList{iF}, 'T1.nii');
%     oCopy       = fullfile( ODIR, ['PHnonBsup_' FList{iF} '_T1.nii']);    
%     xASL_Copy( iCopy, oCopy);            
end
