...
x.S.TraSlices       = 53;
for iL=1:2
    NativeT1w{iL}   = xASL_vis_TransformData2View(IM_T1w_MNI{iL}, x);
    NativeT1w{iL}   = xASL_vis_CreateVisualFig( x,  IM_T1w_MNI{iL}, [], [0.85], [], x.S.gray);
    Im50{iL}        = xASL_vis_CreateVisualFig( x, {Path_T1w_MNI{iL} Path_PV_50{iL}}, [], [0.65 1], [], {x.S.gray x.S.red});
    Im70{iL}        = xASL_vis_CreateVisualFig( x, {Path_T1w_MNI{iL} Path_PV_70{iL}}, [], [0.65 1], [], {x.S.gray x.S.red});
end
