...
for iL=1:length(DirP)
    ...
    Im50im{iL} = xASL_vis_CreateVisualFig(x, {T1im{iL} Im50{iL}}, [], [1 0.65], [], {x.S.gray x.S.red}, [], {MaskIn{iL} MaskIn{iL}}, bWhite);
    Im70im{iL} = xASL_vis_CreateVisualFig(x, {T1im{iL} Im70{iL}}, [], [1 0.65], [], {x.S.gray x.S.red}, [], {MaskIn{iL} MaskIn{iL}}, bWhite);
