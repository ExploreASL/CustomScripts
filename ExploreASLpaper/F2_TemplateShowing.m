...
DATA_OUT    = xASL_vis_TransformData2View( IM, x );
TotalIM     = xASL_vis_TileImages(DATA_OUT,1);
...
DATA_OUTmask    = xASL_vis_TransformData2View( IMmask, x );
DATA_OUT        = xASL_vis_TransformData2View( IM, x );

TotalIMmask     = xASL_vis_TileImages(DATA_OUTmask,1);
TotalIM         = xASL_vis_TileImages(DATA_OUT,1);
