...
clear Figure1
for ii=1:3
    Figure1{ii} = xASL_vis_CreateVisualFig(x, {IM(:,:,:,ii)}, [], [1 0.75 0.75], [], {x.S.gray x.S.red x.S.blue}, 0);
end
...
clear Figure2
for ii=1:3
    Figure2{ii} = xASL_vis_CreateVisualFig(x, {IM(:,:,:,ii) c2}, [], [1 0.75 0.75], [], {x.S.gray x.S.red x.S.blue }, 0);
end
