...
for iL=1:length(DirP)
    ...
    NativeT1w{iL} = xASL_vis_CreateVisualFig(x, T1im{iL}, [], 1, [], x.S.gray, [], MaskIn{iL}, bWhite);
    Im50im{iL} = xASL_vis_CreateVisualFig(x, {T1im{iL} Path_im50{iL}}, [], [1 0.65], [], {x.S.gray x.S.red}, [], {MaskIn{iL} MaskIn{iL}}, bWhite);
    Im70im{iL} = xASL_vis_CreateVisualFig(x, {T1im{iL} Path_im70{iL}}, [], [1 0.65], [], {x.S.gray x.S.red}, [], {MaskIn{iL} MaskIn{iL}}, bWhite);
